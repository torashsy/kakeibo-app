  ...
  return (
    <div style={{ ...styles.app, ...themeVars(theme) }}>
      ...
      <main style={{ ...styles.main, ...((tab === "today" || tab === "records") ? { padding: "12px 16px calc(106px + env(safe-area-inset-bottom))" } : {}) }}>
        ...
        {tab === "plan" && <PlanView plans={plans} onSave={commitPlans} subs={subs} debt={debt} entries={entries} ym={ym} closedMonths={closedMonths} onToggleClosedMonth={toggleClosedMonth} onClearEntries={clearAllEntries} />}
