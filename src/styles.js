...
export const styles = {
  app: { maxWidth: 480, margin: "0 auto", minHeight: "100vh", background: PAPER, color: INK, fontFamily: "var(--font)", fontSize: "var(--base-size)", letterSpacing: "var(--tracking)", position: "relative", paddingBottom: "calc(88px + env(safe-area-inset-bottom))", WebkitFontSmoothing: "antialiased" },
  ...
  fab: { position: "fixed", right: "max(18px, calc(50% - 240px + 18px))", bottom: "calc(104px + env(safe-area-inset-bottom))", width: 58, height: 58, borderRadius: "50%", background: ACCENT, color: "#fff", border: "none", boxShadow: "0 8px 22px rgba(0,0,0,0.38)", cursor: "pointer", zIndex: 6, display: "flex", alignItems: "center", justifyContent: "center" },
  tabs: { position: "fixed", bottom: 0, left: "50%", transform: "translateX(-50%)", width: "100%", maxWidth: 480, boxSizing: "border-box", display: "flex", paddingBottom: "env(safe-area-inset-bottom)", background: "var(--tab-bg)", borderTop: `1px solid ${LINE}`, zIndex: 6 },
  tabBtn: { flex: 1, minWidth: 0, minHeight: 68, border: "none", background: "transparent", padding: "11px 0 10px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", cursor: "pointer", fontFamily: "inherit", touchAction: "manipulation" },
