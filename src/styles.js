...
export const styles = {
  ...
  sheetBackdrop: { position: "fixed", top: "var(--vv-offset-top, 0px)", left: 0, right: 0, height: "var(--visual-viewport-height, 100dvh)", background: "rgba(28,35,33,0.35)", zIndex: 20, display: "flex", alignItems: "flex-end", justifyContent: "center" },
  sheet: { width: "100%", maxWidth: 480, boxSizing: "border-box", background: PAPER, borderRadius: "20px 20px 0 0", padding: "10px 18px calc(20px + env(safe-area-inset-bottom))", maxHeight: "calc(var(--visual-viewport-height, 100dvh) - 8px)", overflowY: "auto", overscrollBehavior: "contain", WebkitOverflowScrolling: "touch", animation: "slideUp 0.22s ease" },
  miniSheet: { width: "100%", maxWidth: 480, boxSizing: "border-box", background: PAPER, borderRadius: "20px 20px 0 0", padding: "18px 18px calc(20px + env(safe-area-inset-bottom))", maxHeight: "calc(var(--visual-viewport-height, 100dvh) - 8px)", overflowY: "auto", overscrollBehavior: "contain", animation: "slideUp 0.22s ease" },
