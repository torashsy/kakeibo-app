...
export const styles = {
  ...
  subGroupTotal: { fontSize: "var(--num-size)", fontWeight: 700, color: INK, fontVariantNumeric: "var(--num-variant)", fontFamily: "var(--num-font)" },
  subtotalRow: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "11px 2px", marginTop: 2, borderTop: `1.5px solid ${LINE}`, fontSize: 14, fontWeight: 800, color: INK },
  subtotalNum: { fontSize: "var(--num-size)", fontWeight: 800, color: INK, fontVariantNumeric: "var(--num-variant)", fontFamily: "var(--num-font)" },
