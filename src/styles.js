...
export const styles = {
  ...
  sheetBackdrop: { position: "fixed", inset: 0, height: "var(--visual-viewport-height, 100dvh)", background: "rgba(28,35,33,0.35)", zIndex: 20, display: "flex", alignItems: "flex-end", justifyContent: "center" },
