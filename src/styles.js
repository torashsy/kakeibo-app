...
export const styles = {
  ...
  th: { padding: "8px 10px", fontSize: 11, fontWeight: 600, color: MUTED, background: "var(--th-bg)", borderBottom: `1px solid ${LINE}`, whiteSpace: "nowrap", textAlign: "right", width: "1%" },
  ...
  tdNum: { padding: "6px 10px", borderBottom: `1px solid ${PAPER}`, textAlign: "var(--num-align)", whiteSpace: "nowrap", fontSize: "var(--num-size)", width: "1%" },
