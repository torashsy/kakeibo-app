...
export const styles = {
  app: { maxWidth: 480, margin: "0 auto", minHeight: "100vh", background: PAPER, color: INK, fontFamily: "var(--font)", fontSize: "var(--base-size)", letterSpacing: "var(--tracking)", position: "relative", paddingBottom: "calc(86px + env(safe-area-inset-bottom))", WebkitFontSmoothing: "antialiased" },
  ...
  editRowRight: { display: "grid", gridTemplateColumns: "112px 14px", alignItems: "center", gap: 6, width: 132, flexShrink: 0, textAlign: "right" },
  ...
  editSubRow: { display: "grid", gridTemplateColumns: "minmax(0,1fr) 132px", gap: 8, alignItems: "center", width: "100%", boxSizing: "border-box", padding: "8px 2px 8px 22px", background: "var(--subtotal-bg)", border: "none", borderBottom: `1px solid ${PAPER}`, cursor: "pointer", fontFamily: "inherit", textAlign: "left" },
  itemRow: { display: "grid", gridTemplateColumns: "minmax(0,1fr) 132px", gap: 8, alignItems: "center", width: "100%", boxSizing: "border-box", padding: "var(--row-pad) 2px", background: "transparent", border: "none", borderBottom: `1px solid ${PAPER}`, cursor: "pointer", fontFamily: "inherit", textAlign: "left" },
  itemRowLeft: { display: "flex", alignItems: "center", gap: 6, minWidth: 0 },
  chevSpacer: { display: "inline-block", width: 16 },
  subGroupHead: { display: "grid", gridTemplateColumns: "minmax(0,1fr) 132px", gap: 8, alignItems: "center", padding: "8px 2px 6px", fontSize: 12, fontWeight: 600, color: MUTED, borderBottom: `1px solid ${LINE}` },
  subGroupTotal: { fontSize: "var(--num-size)", fontWeight: 600, color: INK, fontVariantNumeric: "var(--num-variant)", fontFamily: "var(--num-font)" },
  subtotalRow: { display: "grid", gridTemplateColumns: "minmax(0,1fr) 132px", gap: 8, alignItems: "center", padding: "11px 2px", marginTop: 2, borderTop: `1.5px solid ${LINE}`, fontSize: 14, fontWeight: 600, color: INK },
  ...
  collapseRow: { display: "grid", gridTemplateColumns: "minmax(0,1fr) 132px", gap: 8, alignItems: "center", width: "100%", boxSizing: "border-box", padding: "12px 2px", background: "transparent", border: "none", borderBottom: `1px solid ${PAPER}`, cursor: "pointer", fontFamily: "inherit", textAlign: "left" },
  countBadge: { fontSize: 11, color: MUTED, background: "var(--group-bg)", borderRadius: 6, padding: "1px 7px", fontWeight: 600 },
  listRow: { display: "grid", gridTemplateColumns: "minmax(0,1fr) 132px", gap: 8, alignItems: "center", width: "100%", boxSizing: "border-box", padding: "var(--row-pad) 2px", background: "transparent", border: "none", borderBottom: `1px solid ${PAPER}`, cursor: "pointer", fontFamily: "inherit", textAlign: "left" },
  catTag: { fontSize: 10.5, fontWeight: 600, border: "1px solid", borderRadius: 5, padding: "1px 6px" },
  detailItem: { fontSize: 14 },
  detailTotal: { fontSize: "var(--num-size)", fontWeight: 600, fontVariantNumeric: "var(--num-variant)", fontFamily: "var(--num-font)", textAlign: "right", whiteSpace: "nowrap" },
  ...
  tableScroll: { overflowX: "auto", border: `1px solid ${LINE}`, borderRadius: 12, background: "var(--card-bg)", WebkitOverflowScrolling: "touch", width: "fit-content", maxWidth: "100%" },
  table: { borderCollapse: "collapse", fontSize: 12.5, fontVariantNumeric: "var(--num-variant)", fontFamily: "var(--num-font)", tableLayout: "fixed" },
  ...
  thSticky: { position: "sticky", left: 0, zIndex: 2, textAlign: "left", background: "var(--th-bg)", overflow: "hidden", textOverflow: "ellipsis" },
  thTotal: { borderLeft: `1px solid ${LINE}`, textAlign: "right" },
  td: { padding: "8px 10px", borderBottom: `1px solid ${PAPER}`, whiteSpace: "nowrap" },
  tdSticky: { position: "sticky", left: 0, background: "var(--card-bg)", zIndex: 1, fontWeight: 600, borderRight: `1px solid ${LINE}`, textAlign: "var(--label-align)", overflow: "hidden", textOverflow: "ellipsis" },
  ...
  fab: { position: "fixed", right: "max(18px, calc(50% - 240px + 18px))", bottom: "calc(100px + env(safe-area-inset-bottom))", width: 58, height: 58, borderRadius: "50%", background: ACCENT, color: "#fff", border: "none", boxShadow: "0 8px 22px rgba(0,0,0,0.38)", cursor: "pointer", zIndex: 6, display: "flex", alignItems: "center", justifyContent: "center" },
  tabs: { position: "fixed", bottom: 0, left: "50%", transform: "translateX(-50%)", width: "100%", maxWidth: 480, boxSizing: "border-box", display: "flex", paddingBottom: "calc(10px + env(safe-area-inset-bottom))", background: "var(--tab-bg)", borderTop: `1px solid ${LINE}`, zIndex: 6 },
  tabBtn: { flex: 1, minWidth: 0, minHeight: 55, border: "none", background: "transparent", padding: "9px 0 11px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", cursor: "pointer", fontFamily: "inherit", touchAction: "manipulation" },
  sheetBackdrop: { position: "fixed", top: "var(--vv-offset-top, 0px)", left: "var(--vv-offset-left, 0px)", width: "var(--visual-viewport-width, 100vw)", height: "var(--visual-viewport-height, 100dvh)", boxSizing: "border-box", overflow: "hidden", overscrollBehavior: "none", background: "rgba(28,35,33,0.35)", zIndex: 20, display: "flex", alignItems: "flex-end", justifyContent: "center" },
  sheet: { width: "100%", maxWidth: 480, minWidth: 0, boxSizing: "border-box", background: PAPER, borderRadius: "20px 20px 0 0", padding: "10px 18px calc(20px + env(safe-area-inset-bottom))", maxHeight: "calc(var(--visual-viewport-height, 100dvh) - 8px)", overflowX: "hidden", overflowY: "auto", overscrollBehavior: "contain", touchAction: "pan-y", WebkitOverflowScrolling: "touch", animation: "slideUp 0.22s ease" },
  miniSheet: { width: "100%", maxWidth: 480, minWidth: 0, boxSizing: "border-box", background: PAPER, borderRadius: "20px 20px 0 0", padding: "18px 18px calc(20px + env(safe-area-inset-bottom))", maxHeight: "calc(var(--visual-viewport-height, 100dvh) - 8px)", overflowX: "hidden", overflowY: "auto", overscrollBehavior: "contain", touchAction: "pan-y", WebkitOverflowScrolling: "touch", animation: "slideUp 0.22s ease" },
  ...
  // まとめ入力(MonthlyClose)
  mcHead: { fontSize: 12.5, fontWeight: 700, color: INK, margin: "16px 2px 8px", paddingTop: 12, borderTop: `1px solid ${LINE}` },
  mcRow: { display: "flex", alignItems: "center", gap: 10, marginBottom: 8 },
  ...
  mcFlowRow: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "4px 0", fontSize: 13, fontVariantNumeric: "tabular-nums" },
